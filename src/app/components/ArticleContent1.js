              ...
              <div className="flex min-h-full items-center justify-center p-4 text-center">
                ...
                <div className='m-5 flex items-center justify-center'>
                  <a className='flex px-4 py-2 mx-2 text-sm font-medium border-2 btn-active underline-thickness-1 hover:underline hover:bg-[#1F1F1F] hover:text-[#F2F2F2]
                    cursor-pointer transition-colors duration-300' href='https://airtable.com/appL41ESosi23CmVb/tblVt1Z6mmqUEvCFM/viwIPcmr2QNfjHKW2' target='_blank'>เข้าสู่ระบบ</a>
                    <a className='flex px-4 py-2 mx-2 text-sm font-medium border-2 btn-active underline-thickness-1 hover:underline hover:bg-[#1F1F1F] hover:text-[#F2F2F2]
                    cursor-pointer transition-colors duration-300' href='https://airtable.com/shrOw4kbtV4ghnpRW' target='_blank'>ขอลงงานประชาสัมพันธ์
