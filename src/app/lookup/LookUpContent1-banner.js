                    ...
                    <div className="col-span-2">
                        <div class="grid gap-2 mx-10">
                            <div class="col-span-4">
                                <p className='text-7xl text-[#F8E1EA]'>ความสัมพันธ์ <b>ครู-ศิษย์</b></p>    
                            </div>
                            <div class="col-span-4">
                                <div className='flex text-2xl mt-2 text-[#F8E1EA] mb-0'>
                                เมื่อศิษย์เคารพ “ติวเตอร์” กับ “ครู” ไม่เท่ากัน – บทความล่าสุดจากฝ่ายศิลปวัฒนธรรม สามารถอ่านได้แล้ววันนี้
                                </div>
                            </div>
                            <div class="col-span-4 mt-2">
                                <a type='button' href='/lookup/180823_1' className='flex px-2 py-1 border-2 border-[#F8E1EA] w-fit h-auto mt-2 text-[#F8E1EA] underline-thickness-1 hover:underline hover:bg-[#F8E1EA] hover:text-[#1F1F1F]
              ...
              <div className="flex min-h-full items-center justify-center p-4 text-center">
                ...
                >
                 <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  >
                    บทความบางส่วนไม่มีในหน้านี้
                  </Dialog.Title>
                  <div className="mt-2">
                    <p className="text-sm text-gray-500 text-justify">
                      ขออภัยในความไม่สะดวก หากคุณไม่สามารถอ่านบทความบางส่วนที่มีอยู่ในเว็บไซต์เดิมของ ก.อศ. เนื่องจากเจ้าของบทความไม่ต้องการนำบทความมาแสดงในเว็บไซต์ใหม่
                    </p>
                  </div>
